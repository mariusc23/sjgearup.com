...
/*******************************
	Hack: USE JQUERY 1.4 latest from AJAX Google API
 ******************************/
if (!is_admin()) {
...
function header_featured_posts($carousel_posts, $display = true) { ?>
	<div class="carousel-container"<?php if (!$display): ?> style="display: none;"<?php endif; ?>>
		<?php $first_post = true; ?>
...
function twentyten_setup() {
	...
	define( 'HEADER_IMAGE_HEIGHT', apply_filters( 'twentyten_header_image_height', 420 ) );

	// We'll be using post thumbnails for custom header images on posts and pages.
	// We want them to be 960 pixels wide by 420 pixels tall.
 ...
 * @return int
 */
function sjgearup_excerpt_length( $length ) {
	return 40;
}
add_filter( 'excerpt_length', 'sjgearup_excerpt_length' );
...
function mytheme_setup() {
	add_image_size('featured-thumbnail',960,420, true);
	add_image_size('maximum',572,858, false);
}
...
function create_help_page() {
  add_menu_page('Help','Help','administrator','themes.php?goto=help-page');
  add_submenu_page('themes.php?goto=help-page', __('Add new post','add-post'), __('Add new post','add-post'), 'manage_options', 'themes.php?goto=help-page-one');
  add_submenu_page('themes.php?goto=help-page', __('Add new page','add-page'), __('Add new page','add-page'), 'manage_options', 'themes.php?goto=help-page-two');
  add_submenu_page('themes.php?goto=help-page', __('Schedule post','schedule-post'), __('Schedule post','schedule-post'), 'manage_options', 'themes.php?goto=help-page-three');
  ...
  if ($pagenow=='themes.php' && !empty($_GET['goto'])) {
    switch ($_GET['goto']) {
      ...
      default:
        ...
        break;
	  case 'help-page-one':
        wp_redirect("../adding-a-new-post");
        break;
      default:
        wp_safe_redirect('/wp-admin/');
        break;
	  case 'help-page-two':
        wp_redirect("../adding-a-new-page");
        break;
      default:
        wp_safe_redirect('/wp-admin/');
        break;
	  case 'help-page-three':
        wp_redirect("../scheduling-a-post");
        break;
      default:
        wp_safe_redirect('/wp-admin/');
        break;
	  case 'help-page-four':
        wp_redirect("../posting-to-your-blog");
        break;
      default:
        wp_safe_redirect('/wp-admin/');
        break;
	  case 'help-page-five':
        wp_redirect("../add-a-post-to-the-carousel");
        break;
      default:
        wp_safe_redirect('/wp-admin/');
        break;
	  case 'help-page-six':
        wp_redirect("../inserting-an-image-in-a-post");
        break;
      default:
        wp_safe_redirect('/wp-admin/');
        break;
